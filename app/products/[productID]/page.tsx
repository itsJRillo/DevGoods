                            ...
                            {!product ? (
                                <>
                                    ...
                                    <div className="flex flex-wrap gap-4 mt-10">
                                        <button type="button" className="btn btn-primary hover:bg-black hover:text-white px-4 py-2.5 border bg-transparent text-sm font-bold rounded">Buy now</button>
                                        <button type="button" className="btn btn-primary hover:bg-black hover:text-white px-4 py-2.5 border bg-transparent text-sm font-bold rounded" onClick={handleAddCart}>Add to cart</button>
                                    </div>
                                </>
                            ) : (
                                <>
                                    ...
                                    <div className="flex flex-wrap gap-4 mt-10">
                                    <button type="button" className="btn btn-primary hover:bg-white hover:text-black px-4 py-2.5 border text-sm font-bold rounded">Buy now</button>
                                        <button type="button" className="btn bg-white hover:bg-black hover:text-white px-4 py-2.5 border text-sm font-bold rounded" onClick={handleAddCart}>Add to cart</button>
                                    </div>
                                </>)
                            }
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center">
                                        ...
                                        <div className="bg-gray-400 rounded w-full h-2 ml-3">
                                            <div className="h-full rounded bg-[#333]" style={{ width: `${averageRating * 20}%` }}></div>
                                        </div>
